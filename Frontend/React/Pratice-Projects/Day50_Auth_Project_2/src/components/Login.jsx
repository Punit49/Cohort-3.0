...
const Login = () => {
        ...
        const { handleSubmit, handleLogin, register, errors } = useAuth();

        return (
            <div className=" h-150 bg-[#0F0F0F] flex items-center justify-center px-6">
            <div className="w-full max-w-md bg-[#181818] border border-zinc-800 rounded-3xl p-8 shadow-2xl">
                ...
                <form onSubmit={handleSubmit(handleLogin)} className="mt-8 space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            {...register("password", {
                                required: "Password ke bina kese kaam chalega bhai"
                            })}
                            type="password"
                ...
                <p className="text-center text-zinc-400 mt-6 text-sm">
                    ...
                    <NavLink to={"/register"} className="text-red-500 cursor-pointer ml-1">
                        Register
                    </NavLink>
                </p>
            </div>
